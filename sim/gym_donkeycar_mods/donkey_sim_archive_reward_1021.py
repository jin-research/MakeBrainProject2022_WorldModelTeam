# This file is derived from gym-donkeycar (MIT License).
#   https://github.com/tawnkramer/gym-donkeycar
#   base commit 4ea670491eaef66178a1ffe3d672c7d4344c51bf
# Copyright (c) 2018 Tawn Kramer / Roma Sokolkov / Leigh Johnson
# Modified by Make Brain Project 2022, Group 22-A.
# Full license text: ../../third_party/gym-donkeycar/LICENSE
...
class DonkeyUnitySimHandler(IMesgHandler):
    def __init__(self, conf: Dict[str, Any]):
        ...
        #print("conf["max_cte"]",conf["max_cte"])
        self.timer = FPSTimer()

        # sensor size - height, width, depth
        self.camera_img_size = conf["cam_resolution"]
        print("DonkeyUnitySimHandler, conf[cam_resolution]",conf["cam_resolution"])
    ...
    def calc_reward(self, done: bool) -> float:
        ...
        print("image_array.shape ", self.image_array.shape)
        ...
        base_all_square_pixel_percentage = 15 #[%]
        ...
        return ( ( all_square_pixel_percentage / base_all_square_pixel_percentage )**2) * (self.speed / max_speed)
